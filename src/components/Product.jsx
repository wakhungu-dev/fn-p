...
export default function Product({
    ...
    async function uploadImages(event) {
        ...
        if (files?.length > 0){
            ...
            uploadImagesQuery.push(axios.post('/api/upload', data).then(res =>{
    ...
    return (
        <form onSubmit={createProduct} className="mx-auto max-w-screen-sm">
            <div className="mx-auto my-4">
                <div>
                    <label htmlFor="title" className="mb-1 block text-lg font-medium text-gray-700 py-2">
                        Title
                    </label>
                    <input 
                        type="text" 
            ...
            <div className="mx-auto my-4">
                <div className="mx-auto">
                    <label htmlFor="images" className="mb-1 block text-lg font-medium text-gray-700">
                        Images
                    </label>
            ...
            <div className="grid grid-cols-2 items-center rounded">
                    {isUploading && (
                        <Spinner className='p-4 absolute top-1/2 left-1/2 transform -
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
            ...
            <div className="mx-auto my-4">
                <div>
                    <label htmlFor="description" className="mb-1 block text-lg font-medium text-gray-700 py-2">
                        Description
                    </label>
                    <textarea
                        rows={5}
            ...
            <div className="mx-auto my-4">
                <div>
                    <label htmlFor="price" className="mb-1 block text-lg font-medium text-gray-700 py-2">
                        Price
                    </label>
                    <input
                        type="number"
