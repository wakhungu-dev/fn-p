...
const handleSubmit = (e: FormEvent) => {
    ...
    axios.put(`/api/edit_product/${productData._id}`, inputData).then
    (res =>{
...
setOpenPopup(false)}
  ...
  return (
    ...
    place-items-center'>
        <div className='bg-white w-[700px] py-8
        rounded-lg text-center relative'>
            <IoIosCloseCircleOutline className=' absolute top-0 right-0 text-2xl cursor-pointer hover:text-red-600'
